...
/* ======= clash ======= */
// https://github.com/guanzhenbin/clash-core/releases/tag/v1.8
// https://github.com/guanzhenbin/clash-core/releases/download/v1.8/clash-darwin-amd64-v1.18.0.gz
//https://github.com/guanzhenbin/clash-core/releases/download/v1.8/clash-darwin-amd64-v1.8.gz
const CLASH_URL_PREFIX =
  // clash-darwin-amd64-v1.8.gz

  // "https://github.com/Dreamacro/clash/releases/download/premium/";
  " https://github.com/guanzhenbin/clash-core/releases/download/v1.8/";
const CLASH_LATEST_DATE = "v1.8";
// 0529
const CLASH_MAP = {
